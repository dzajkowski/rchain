...
object CasperPacketHandler extends CasperPacketHandlerInstances {
  ...
  def of[F[_]: LastApprovedBlock: Metrics: BlockStore: ConnectionsCell: NodeDiscovery: TransportLayer: ErrorHandler: RPConfAsk: SafetyOracle: Capture: Sync: Concurrent: Time: Log: MultiParentCasperRef](
      conf: CasperConf,
  ...
  /** Node in this state is a genesis block validator. It will respond only to
    ...
    **/
  private[comm] class GenesisValidatorHandler[F[_]: Capture: Sync: Concurrent: ConnectionsCell: NodeDiscovery: TransportLayer: Log: Time: SafetyOracle: ErrorHandler: RPConfAsk: BlockStore: LastApprovedBlock](
      runtimeManager: RuntimeManager,
  ...
  object StandaloneCasperHandler {
    def approveBlockInterval[F[_]: Sync: Capture: Concurrent: ConnectionsCell: NodeDiscovery: BlockStore: TransportLayer: Log: Time: ErrorHandler: SafetyOracle: RPConfAsk: LastApprovedBlock: MultiParentCasperRef](
  ...
  /** Node in this state will query peers in the network with [[ApprovedBlockRequest]] message
    ...
    **/
  private[comm] class BootstrapCasperHandler[F[_]: Sync: Concurrent: Capture: ConnectionsCell: NodeDiscovery: BlockStore: TransportLayer: Log: Time: ErrorHandler: SafetyOracle: RPConfAsk: LastApprovedBlock](
      runtimeManager: RuntimeManager,
      shardId: String,
      validatorId: Option[ValidatorIdentity],
  ...
  private def onApprovedBlockTransition[F[_]: Sync: Concurrent: Time: ErrorHandler: SafetyOracle: RPConfAsk: TransportLayer: Capture: ConnectionsCell: Log: BlockStore: LastApprovedBlock](
      b: ApprovedBlock,
      validators: Set[ByteString],
      runtimeManager: RuntimeManager,
      validatorId: Option[ValidatorIdentity],
