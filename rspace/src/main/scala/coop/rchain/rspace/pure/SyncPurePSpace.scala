...
import coop.rchain.rspace.{Blake2b256Hash, Checkpoint, ISpace, Match}

import scala.collection.immutable.Seq
import scala.language.higherKinds

class SyncPurePSpace[F[_], C, P, A, R, K](space: ISpace[C, P, A, R, K])
    extends PureRSpace[F, C, P, A, R, K] {
